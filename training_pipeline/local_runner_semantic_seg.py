...
from pipeline import configs_semantic_seg as configs
from pipeline import local_pipeline_semantic_seg as local_pipeline
...
DATA_PATH = os.path.join(os.path.dirname(os.path.abspath(__file__)), "data/semantic-seg")
